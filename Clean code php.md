...
8. [[#Не повторяйся (Don’t repeat yourself, DRY)]]

## Введение

Это принципы разработки ПО, взятые из книги
[_Чистый код_](https://www.labirint.ru/books/642466/) Роберта Мартина и
...
рекомендации, не более, но все они кодифицированы в многолетнем коллективном опыте автора _Clean Code_.
